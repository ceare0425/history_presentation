...
실행:
    python server.py [포트(기본 8898)]

접속:
    학생  http://<이 컴퓨터의 IP>:8898/play
    관리자 http://<이 컴퓨터의 IP>:8898/admin
    큰화면 http://<이 컴퓨터의 IP>:8898/board
"""
import json
import os
import random
...
def main():
    ...
    print("=" * 60)
    print(f"한국사 복습 게임 서버 시작 (문제 {n}개 로드됨)")
    print("=" * 60)
