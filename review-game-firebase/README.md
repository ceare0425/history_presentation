...
- **난타전 (난투)**: **저격 아이템이 주력**인 난투 모드. **정답을 맞힐 때마다** 아이템 1개.
  ...
  - 저격 대상은 **상위 3등**(격차 조건 없음). 아래 등수도 상위권을 쏠 수 있고, 상위권끼리도 서로 침. 상위 3명 중 균등 추첨.
  - **상위 3등 본인**은 🍵해독·🛟구명조끼·🪞반사경이 훨씬 자주 나오고, 자기가 쏘는 저격은 덜 나옴 — 얻어맞으며 버티는 자리.
  - 피격 후 무적 **1.5초**뿐(연달아 얻어맞음). 방해 효과는 매운맛 수준이지만 🌫️안개·🧊얼음은 **5초**로 짧게, ⬇️미끄럼틀 **-5층**(2등 아래 보호 없이 0층까지)·🥷강탈 **-5층**(나도 +5층).
  - 🎲인생 한방은 **안 나옴**. 🛋️방구석 축제(하위권 혼자 30초 2배)는 그대로 나옴.
