...
- **끄기**: 기존과 동일.
- **난타전**: 자기 강화 + 전체 이벤트만. 남을 방해하는 아이템은 안 나옵니다. **정답을 맞힐 때마다** 아이템 1개.
  - ⚡부스터(다음 정답 3개 2배) · 🪜사다리(+2층) · 🚀로켓 점프(+5층, 다음 정답 1번 층수 없음)
  - 🔁리롤(문제 교체) · 💡힌트(초성 공개, 이 문제는 +1층) · 🛡️콤보 방패(다음 오답에도 연속 유지)
  - 🍵해독(나에게 걸린 방해 해제) · 🌈축제(20초간 모두 2배) 등
- **매운맛**: 난타전 아이템 + **선두권 견제** 아이템. **3연속 정답마다** 아이템 1개.
  - 🌫️안개(문제 8초 흐림) · 🧊얼음(8초 제출 불가) · 🐌느림보(다음 정답 +1층만) · ⬇️미끄럼틀(-3층) · 🥷강탈

**획득**: 보유는 1개 한도, 쓰기 전엔 새로 안 들어옴. (구버전 '순한맛'은 난타전으로 자동 취급)

**선두권 견제 규칙** (뒷말이 안 나오게 만든 장치):
