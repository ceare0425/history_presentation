...
있습니다. 카카오톡처럼 **상대방이 읽으면 "1"이 사라지는 읽음 표시**도 있습니다 — 관리자 대화창에서는
선생님이 보낸 말풍선에 학생이 아직 안 읽었으면 "1"이 붙어 있다가 학생 화면에 배너로 뜨는 순간 사라지고,
학생이 보낸 답장은 선생님이 그 학생과의 대화창을 열어 실제로 보는 순간 읽음 처리되어 학생 쪽 배너에
"선생님이 읽었어요"로 표시됩니다.
