...
- **난타전 (난투)**: **저격 아이템이 주력**인 난투 모드. **정답을 맞힐 때마다** 아이템 1개.
  - 뽑히는 것의 대부분이 방해 아이템(🌫️안개·🧊얼음·🐌느림보·⬇️미끄럼틀·🥷강탈), 반격용 🍵해독·🪞반사경도 자주.
  - **상위권이든 아니든 누구나** 저격을 쏘고 맞음. 대상은 "**나보다 위에 있는 사람 아무나**"(격차 조건 없음), 특정인 쏠림 방지로 균등 추첨.
  - 피격 후 무적 **1.5초**뿐(연달아 얻어맞음). 방해 효과는 매운맛 수준, ⬇️미끄럼틀 **-5층**(2등 아래 보호 없이 0층까지).
  - 🎲인생 한방·🛋️방구석 축제는 **안 나옴**. 큰 층수 자기 강화(🎫복권·🎰룰렛 등)도 가끔 섞이지만 비중 낮음.
