...
- **끄기**: 기존과 동일.
- **순한맛**: 자기 강화 + 전체 이벤트만. 남을 방해하는 아이템은 안 나옵니다.
  - ⚡부스터(다음 정답 3개 2배) · 🪜사다리(+2층) · 🚀로켓 점프(+5층, 다음 정답 1번 층수 없음)
  - 🔁리롤(문제 교체) · 💡힌트(초성 공개, 이 문제는 +1층) · 🛡️콤보 방패(다음 오답에도 연속 유지)
  - 🍵해독(나에게 걸린 방해 해제) · 🎁산타(모두 +1층) · 🌈축제(20초간 모두 2배)
- **매운맛**: 위 + **선두권 견제** 아이템.
  - 🌫️안개(문제 8초 흐림) · 🧊얼음(5초 제출 불가) · 🐌느림보(다음 정답 +1층만) · ⬇️미끄럼틀(-3층)

**획득**: 3연속 정답마다 아이템 1개(보유는 1개 한도, 쓰기 전엔 새로 안 들어옴).
