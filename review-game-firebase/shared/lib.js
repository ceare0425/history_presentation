...
import {
  getDatabase, ref, onValue, onChildAdded, get, set, update, remove, push, child, onDisconnect
...
export { ref, onValue, onChildAdded, get, set, update, remove, push, child, onDisconnect };
